...
describe("Transaction model", () => {
    ...
    describe("Given find user by uid", () => {
        ...
        describe('Given find transaction by uid', () => {
            ...
            test('when user doesnt own transaction, then return error 403', async () =>{
            ...
            describe('Given update transaction', () => {
                ...
                test('when transaction doesnt exist, then return error 404', async () => {
                    const model = new Transaction({
                        findByUid: () => Promise.resolve(null)
                    });
                    model.uid = 1;
